...
class InventoryController extends ResourceController
{
    ...
    public function transfer()
    {
        ...
        try {
            ...
            foreach ($data->items as $item) {
                ...
                if (!$product) throw new \Exception("Product $code not found");
            ...
            // J1 (Source): Cr Inventory (1004), Dr In Transit (1099 or similar)
            ...
            $this->addJournalItem($j1, '1099', $totalValue, 0); // Dr Transit
    ...
    private function addJournalItem($journalId, $accountCode, $debit, $credit) {
        ...
        if (!$account) {
            if ($accountCode == '1099') {
                 // Seed if missing
                 $this->accountModel->insert(['code'=>'1099', 'name'=>'Funds/Goods In Transit', 'type'=>'ASSET', 'normal_balance'=>'DEBIT']);
